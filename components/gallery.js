...
export function GalleryFor({sectionId, section}) {
	const {data} = useSWR('/api/files?section=' + sectionId, fetcher);
	...
	return <div><Gallery photos={dimensions} onClick={openLightbox} renderImage={imageRenderer}/>
		<ModalGateway>
			{viewerIsOpen ? (
