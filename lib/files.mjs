...
export function joinSectionPath(section, filePath = []) {
...
export async function getFilteredFiles(section, filePath = []) {
	const imagePath = joinSectionPath(section, filePath);
...
export async function getFileDates(section, imagePath = []) {
	return magicCache("getFileDates", _getFileDates, section, imagePath);
}

export async function _getFileDates(section, imagePath = []) {
